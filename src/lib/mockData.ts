...
export const predictions: Prediction[] = [
  ...
  {
    id: '13',
    slug: 'ramen-race-first-5k',
    question: 'Will a new solo founder hit $5K MRR within 6 months of launch by Dec 31, 2026?',
    founder_name: 'Ramen Challenge',
    founder_photo_url: theBigOneImg,
    company_name: 'Any New Founder',
    description: 'The first milestone: can a brand-new solo founder reach ramen profitability in just 6 months?',
    yes_pool: 600,
    no_pool: 400,
    volume: 12000,
    resolution_date: '2026-12-31',
    resolution_criteria: 'A solo founder who launched after Jan 1 2026 reaches $5K MRR within 6 months.',
    status: 'open',
    category: 'Ramen Profitable Race',
    created_at: '2024-04-01',
  },
  {
    id: '14',
    slug: 'ramen-race-bootstrapped-1k',
    question: 'Will 10+ solo founders cross $1K MRR on Lazy Decacorn by Dec 31, 2026?',
    founder_name: 'The $1K Club',
    founder_photo_url: theLongGameImg,
    company_name: 'Community Milestone',
    description: 'Can the Lazy Decacorn community produce 10 founders who cross ramen profitability?',
    yes_pool: 800,
    no_pool: 200,
    volume: 9000,
    resolution_date: '2026-12-31',
    resolution_criteria: 'At least 10 founders on the platform reach $1K MRR.',
    status: 'open',
    category: 'Ramen Profitable Race',
    created_at: '2024-04-01',
  },
  {
    id: '15',
    slug: '100m-arr-solo-founder',
    question: 'Will any solo founder reach $100M ARR by Dec 31, 2030?',
    founder_name: 'The $100M Bet',
    founder_photo_url: theBigOneImg,
    company_name: 'Any Solo Founder',
    description: 'The ultimate revenue milestone — can a one-person company hit $100M in recurring revenue?',
    yes_pool: 500,
    no_pool: 1500,
    volume: 78000,
    resolution_date: '2030-12-31',
    resolution_criteria: 'Any solo-founded company reaches $100M ARR as verified by public revenue data.',
    status: 'open',
    category: '$100M ARR Race',
    created_at: '2024-04-01',
  },
  {
    id: '16',
    slug: '100m-arr-pieter-levels',
    question: 'Will Pieter Levels be the first solo founder to $100M ARR?',
    founder_name: 'Pieter Levels',
    founder_photo_url: pieterImg,
    company_name: 'Nomad List / Photo AI',
    description: 'Already the highest-earning indie hacker — can Pieter be first to the $100M mark?',
    yes_pool: 1200,
    no_pool: 800,
    volume: 55000,
    resolution_date: '2030-12-31',
    resolution_criteria: 'Pieter Levels\' combined ARR reaches $100M before any other solo founder.',
    status: 'open',
    category: '$100M ARR Race',
    created_at: '2024-04-01',
  },
  {
    id: '17',
    slug: 'ipo-solo-founder-2030',
    question: 'Will a solo-founded company IPO by Dec 31, 2030?',
    founder_name: 'IPO Watch',
    founder_photo_url: unicornRaceImg,
    company_name: 'Any Solo Founder',
    description: 'Has a solo founder ever rung the opening bell? Predict if it happens this decade.',
    yes_pool: 400,
    no_pool: 1600,
    volume: 62000,
    resolution_date: '2030-12-31',
    resolution_criteria: 'A company with a single founder completes an IPO on a major stock exchange.',
    status: 'open',
    category: 'IPO Race',
    created_at: '2024-04-01',
  },
  {
    id: '18',
    slug: 'ipo-ai-solo-founder',
    question: 'Will an AI-focused solo founder IPO before any other solo founder?',
    founder_name: 'AI IPO First?',
    founder_photo_url: aiWildCardImg,
    company_name: 'AI Founder TBD',
    description: 'AI companies are moving fast — will the first solo-founder IPO come from an AI startup?',
    yes_pool: 700,
    no_pool: 1300,
    volume: 44000,
    resolution_date: '2032-12-31',
    resolution_criteria: 'The first solo-founded company to IPO is primarily an AI company.',
    status: 'open',
    category: 'IPO Race',
    created_at: '2024-04-01',
  },
  {
    id: '19',
    slug: 'acquisition-100m-2028',
    question: 'Will a solo-founded company be acquired for $100M+ by Dec 31, 2028?',
    founder_name: 'Big Exit',
    founder_photo_url: theBigOneImg,
    company_name: 'Any Solo Founder',
    description: 'Makerpad sold to Zapier — can a solo founder land an even bigger exit?',
    yes_pool: 900,
    no_pool: 1100,
    volume: 38000,
    resolution_date: '2028-12-31',
    resolution_criteria: 'A solo-founded company is acquired for $100M+ as reported by credible sources.',
    status: 'open',
    category: 'Acquisition Race',
    created_at: '2024-04-01',
  },
  {
    id: '20',
    slug: 'acquisition-1b-2030',
    question: 'Will a solo-founded company be acquired for $1B+ by Dec 31, 2030?',
    founder_name: 'Billion-Dollar Exit',
    founder_photo_url: theLongGameImg,
    company_name: 'Any Solo Founder',
    description: 'The ultimate acquisition — can a one-person company command a billion-dollar buyout?',
    yes_pool: 300,
    no_pool: 1700,
    volume: 71000,
    resolution_date: '2030-12-31',
    resolution_criteria: 'A solo-founded company is acquired for $1B+ as verified by public reporting.',
    status: 'open',
    category: 'Acquisition Race',
    created_at: '2024-04-01',
  },
...
export const categories = ['All', 'Ramen Profitable Race', 'MRR Race', '$100M ARR Race', 'Unicorn Race', 'Decacorn Race', 'IPO Race', 'Acquisition Race', 'Y Combinator Race', 'Results'];
